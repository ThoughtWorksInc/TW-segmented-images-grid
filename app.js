 ...
 *.jsx
 ...
 --------------------------------
 The system will recursively search for .jsx files exporting either a function(req, res), or
 ...
 (1) Route autowire by verb file (get.jsx, put.jsx, delete.jsx, post.jsx)

 If a .jsx file in the routes directory corresponds to one of the http verbs (eg. get.jsx, put.jsx, delete.jsx, post.jsx),
 ...
 Assuming that /samplelist/backend/routes/config/get.jsx contains the following:
 ...
 If the .jsx file exports a datastructure containing BOTH "verb" string and "route" function attributes,
 ...
 Assuming that this export lives in /samplelist/routes/prod/extra/routes.jsx, the following route will be automatically
 created:
 ...
 --------------------------------
 Though the system will search for .jsx files anywhere under the tile directory, it is good practice to put your
 services related items in a specific backend directory.

 The system will try to discover any event handlers and tasks exported in .jsx files.
 ...
 If in /samplelist/services/lifecycle.jsx this existed:
 ...
 object, which can be either a task object (see jive-sdk/lib/task.jsx) or a function.

 If in /samplelist/backend/datapusher.jsx this existed:
